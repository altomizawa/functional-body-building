...
async function updateUser(userData) {
  // Create partial schema that makes all fields optional
  ...
  try {
    ...
    // Update user fields if they are provided
    if (validatedData.name) existingUser.name = validatedData.name.toLowerCase().trim();
    if (validatedData.email) existingUser.email = validatedData.email.toLowerCase().trim();
